...
public class Bishop extends Piece {
	...
	public void loadImage() {
		try {
			this.setImage(ImageIO.read(new File("C:\\Users\\tosta\\IdeaProjects\\Chess\\w-bishop2.png")), 0);
			this.setImage(ImageIO.read(new File("C:\\Users\\tosta\\IdeaProjects\\Chess\\b-bishop2.png")), 1);
		} catch (IOException e) {
